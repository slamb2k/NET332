...
namespace XmasListService.Controllers
{
    ...
    {
		//
		// Xmas items list for all users. Since the list is stored in memory,
		// it will go away if the service is cycled.
        //
        static readonly ConcurrentBag<GiftItem> GiftBag 
			= new ConcurrentBag<GiftItem>();
